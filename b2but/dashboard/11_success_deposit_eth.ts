  	...
  	<table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="560" style="margin: auto;" class="email-container">
  	  ...
  	  <tr>
  		<td bgcolor="transparent" align="center">
  		  <img src="https://s3.eu-west-2.amazonaws.com/b2b-ico/notification_header.png" width="560" height="" alt="Export Online newsletter header" border="0" align="center" style="width: 100%; max-width: 767px; height: auto; background: #555; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555; margin: auto;" class="g-img">
  		</td>
  	  </tr>
      ...
      <tr>
        ...
        <tr>
          <td bgcolor="#ffffff" style="padding: 0 20px 40px; font-family: sans-serif; font-size: 17px; line-height: 30px; color: #111111; text-align: left; font-weight: 300;">
            <p style="margin: 0;">
              You have successfully deposited {{{amount}}} {{{currency}}} to your contributor’s account and now are officially whitelisted for Export Online's ICO which means that your UTT tokens are already reserved for you. We’ll send the UTT tokens transfer confirmation (along with more details on your contribution) on {{{confirmationDate}}}.<br/>Deposit amount: <b>{{{depositAmount}}} ETH</b>
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td bgcolor="#ffffff" style="padding: 0 20px 40px; font-family: sans-serif; font-size: 17px; line-height: 30px; color: #111111; text-align: left; font-weight: 300;">
            <p style="margin: 0;">
              You can access the details of all your deposits in your personal Сontributor Account <a href="{{{depositDetailsLink}}}">here</a>.
            </p>
          </td>
        </tr>
                ...
                <tr>
                  ...
                  <td width="14.2%" class="social">
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                      <tr>
                        <td style="text-align: center">
                          <a href="https://twitter.com/b2but">
                  ...
                  <td width="14.2%" class="social">
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                      <tr>
                        <td style="text-align: center">
                          <a href="https://www.facebook.com/b2but/">
