    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="560" style="margin: auto;" class="email-container">
      <tr>
        <td bgcolor="transparent" align="center">
          <img src="https://s3.eu-west-2.amazonaws.com/b2b-ico/notification_header.png" width="560" height="" alt="Export Online newsletter header" border="0" align="center" style="width: 100%; max-width: 767px; height: auto; background: #a7d9fb; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555; margin: auto;" class="g-img">
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td bgcolor="#ffffff" style="padding: 0 20px 40px; font-family: sans-serif; font-size: 17px; line-height: 30px; color: #111111; text-align: left; font-weight: 300;">
          <p style="margin: 0;">
            You have successfully signed in to your Export Online account at <b>${ datetime }</b><br/>
          </p>
        </td>
      </tr>
      <tr>
